...
### Note
#### https://react.dev/blog/2024/12/05/react-19#by-convention-functions-that-use-async-transitions-are-called-actionsBy convention, functions that use async transitions are called “Actions”.
...
### https://react.dev/blog/2024/12/05/react-19#new-hook-useactionstateNew hook: useActionState
```
useActionState
```
...
### https://react.dev/blog/2024/12/05/react-19#form-actionsReact DOM: <form> Actions
```
<form>
```
...
### https://react.dev/blog/2024/12/05/react-19#new-hook-useformstatusReact DOM: New hook: useFormStatus
```
useFormStatus
```
...
### https://react.dev/blog/2024/12/05/react-19#new-hook-optimistic-updatesNew hook: useOptimistic
```
useOptimistic
```
...
### https://react.dev/blog/2024/12/05/react-19#new-feature-useNew API: use
```
use
```
...
### Note
#### https://react.dev/blog/2024/12/05/react-19#use-does-not-support-promises-created-in-renderuse does not support promises created in render.
...
### https://react.dev/blog/2024/12/05/react-19#server-componentsServer Components
...
### Note
#### https://react.dev/blog/2024/12/05/react-19#how-do-i-build-support-for-server-componentsHow do I build support for Server Components?
...
### https://react.dev/blog/2024/12/05/react-19#server-actionsServer Actions
...
### Note
#### https://react.dev/blog/2024/12/05/react-19#there-is-no-directive-for-server-componentsThere is no directive for Server Components.
...
### https://react.dev/blog/2024/12/05/react-19#ref-as-a-propref as a prop
```
ref
```
...
### https://react.dev/blog/2024/12/05/react-19#diffs-for-hydration-errorsDiffs for hydration errors
...
### https://react.dev/blog/2024/12/05/react-19#context-as-a-provider<Context> as a provider
```
<Context>
```
...
### https://react.dev/blog/2024/12/05/react-19#cleanup-functions-for-refsCleanup functions for refs
...
### https://react.dev/blog/2024/12/05/react-19#use-deferred-value-initial-valueuseDeferredValue initial value
```
useDeferredValue
```
...
### https://react.dev/blog/2024/12/05/react-19#support-for-metadata-tagsSupport for Document Metadata
...
### Note
#### https://react.dev/blog/2024/12/05/react-19#you-may-still-want-a-metadata-libraryYou may still want a Metadata library
...
### https://react.dev/blog/2024/12/05/react-19#support-for-preloading-resourcesSupport for preloading resources
...
### https://react.dev/blog/2024/12/05/react-19#compatibility-with-third-party-scripts-and-extensionsCompatibility with third-party scripts and extensions
...
### https://react.dev/blog/2024/12/05/react-19#error-handlingBetter error reporting
...
### https://react.dev/blog/2024/12/05/react-19#support-for-custom-elementsSupport for Custom Elements
...
#### https://react.dev/blog/2024/12/05/react-19#how-to-upgradeHow to upgrade
...
[PreviousSunsetting Create React App](https://react.dev/blog/2025/02/14/sunsetting-create-react-app)
