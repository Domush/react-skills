...
- [ ] **Tool-first file operations respected** — No shell-based file writes were used when file tools were available
...
- [ ] **Type-safe** — No `any`, no `@ts-ignore`, no `@eslint-disable` without explicit user permission
...
- [ ] **Modular** — Is the code organized into reusable, independent modules?
- [ ] **Normalized** — Is the code organized into consistent patterns and structures?
- [ ] **Limited file size** — Is each file focused and not overly large (ideally under 300 lines)?
